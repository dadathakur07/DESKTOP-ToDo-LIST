  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'scale-in': 'scale-in 0.4s cubic-bezier(.4,2,.3,1)',
        'scale-out': 'scale-out 0.2s ease-in',
        'slide-in-right': 'slide-in-right 0.7s cubic-bezier(.38,.2,.22,1)',
        'slide-out-right': 'slide-out-right 0.3s cubic-bezier(.38,.2,.22,1)',
